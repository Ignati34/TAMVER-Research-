...
## Scope
Expands the three previously minimal canonical English Research/Knowledge articles into substantive, source-aligned knowledge assets while preserving the v0.8.5 multilingual architecture.
...
- v0.8.5 localized body translations.
...
## Follow-up
A later translation synchronization pass should expand the seven localized versions to the new canonical depth after terminology review.
